...
2. Mapa coroplético mundial (Tab 01) — revelar padrões geográficos do mix energético. Onde está a transição mais avançada, onde persiste o fóssil, como varia a energia per capita e as emissões. O slider de ano dá a evolução temporal.
...
Panorama mundial. Vê-se a escala (KPIs) e explora-se a distribuição geográfica das métricas energéticas. Interativo via slider de ano, toggle de métrica, e click-to-zoom em qualquer país para abrir o cartão com o perfil detalhado.

![Captura de ecrã da Aba 1](Aba1Total.png)
![Captura de ecrã do mapa](mapaInterativo.png)

### 2. [Aba2-Country Rankings]
Comparação entre países. Ranking dos líderes em renováveis + scatter riqueza-vs-renováveis, ambos coordenados pelo mesmo slider de ano.

![Captura de ecrã da Aba 2](Aba2Total.png)

### 3. [Aba3-Portugal in Focus]
Foco no caso português. Slope chart da transição ao longo de ~35 anos + posicionamento face aos peers europeus em 2024.
